...
def handle_message(event):
    ...
    if(message_type == "sticker"):
        ...
        replytext =  random.choice(('會','不會'))  if "會不會" in message else random.choice(('是','不是'))  if "是不是" in message else random.choice(('要','不要')) if '要不要' in message else random.choice(('對','不對')) if '對不對' in message else random.choice(('有','沒有')) if '有沒有' in message else random.choice(('知道','不知道','知你媽'))
